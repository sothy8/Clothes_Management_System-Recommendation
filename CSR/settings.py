...
SECRET_KEY = 'django-insecure-n75&l$(r%q-zxuq&y20!%2!_*dsabg6tu#qvmx9626-+j8*(b!'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.tz', # Timezone context processor
            ],
        },
    },
]
...
#         'NAME': 'Database_CSR',
#         'USER': 'root',
#         'PASSWORD': 'Sothy884',  # Same as Workbench login
#         'HOST': 'localhost',
#         'PORT': '3306',
#     }
# }
...
# Using console backend to print emails to terminal instead of sending real emails
